package com.xiaomu.view.otherview
{
	...
	public class QuestionView extends Panel
	{
		...
		protected function okButton_clickHandler(event:MouseEvent):void
		{
			...
			answer.name = currentQuestion.name;
			...
			if (answer.answers.length == currentQuestion.correctCount)
			{
				answer.correct = true;
				for each(var item:Object in answer.answers)
				{
					if (!item.correct)
			...
			Alert.show(answer.correct ? "恭喜您 回答正确" : "真遗憾 回答错误", "提示");
