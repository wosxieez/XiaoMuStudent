package
{
	...
	public class XiaoMuStudent extends Application
	{
		public function XiaoMuStudent()
		{
			super();
			...
			CocoUI.themeBackgroundColorSelected = Theme.COLOR4;
		...
		override protected function updateDisplayList():void
		{
			...
			homeView.height = height - homeView.y;
		}
